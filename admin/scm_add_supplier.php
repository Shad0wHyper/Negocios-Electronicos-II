...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($name)) {
        ...
        try {
            $db->collection('scm_suppliers')->add([
                'name' => $name,
...
<div class="max-w-4xl mx-auto">
    <h2 class="text-3xl font-bold text-[var(--text-primary)] mb-8">Añadir Fabricante / Proveedor</h2>
    ...
    <form action="scm_add_supplier.php" method="POST" class="bg-white p-8 rounded-lg shadow-sm border border-[var(--border-color)] space-y-6">
        <div>
        ...
        <div>
            ...
            <input type="text" name="contact_person" id="contact_person" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
        </div>
